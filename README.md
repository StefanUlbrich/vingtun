...
> effort in updating dependencies up to a point where the application becomes
> installable via cargo from packages on crates.io only. In addition, I plan
> to port the Godot addon to [GdExt](https://github.com/godot-rust/gdext).
>
> The final version will use the (already outdated but unpatched)
>
> * The latest main of [rend3](https://github.com/BVE-Reborn/rend3) (in maintainance mode)
> * [egui](https://github.com/emilk/egui/tree/0.27.2) in version `0.27.2` which is compatible with `rend3`
> * [winit](https://github.com/rust-windowing/winit/tree/v0.29.4) in version `0.29.4`
>
> This combination seems to satisfy the requirements
>
> I currently have no plans (nor the expertise) to develop new features but
> at one point, I might look into [differential growth](https://github.com/inca/blender-differential-growth)
